...
# 65532 is the nonroot user's -Djdk.lang.Process.launchMechanism=vfork
# used here instead of the name to allow Kubernete-Djdk.lang.Process.launchMechanism=vforks to easily detect that the container
